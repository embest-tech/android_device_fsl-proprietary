...
LOCAL_SRC_FILES := record_profile/media_codecs_imx5x_vpu.xml
else
LOCAL_SRC_FILES := record_profile/media_codecs_vpu.xml
endif
else
LOCAL_SRC_FILES := record_profile/media_codecs.xml
endif
